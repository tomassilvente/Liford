...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const updated = await db.savingsGoal.update({
    ...
    data: {
      ...
      ...(body.autoContributionAmount !== undefined && { autoContributionAmount: body.autoContributionAmount !== null ? Number(body.autoContributionAmount) : null }),
      ...(body.autoContributionDay !== undefined && { autoContributionDay: body.autoContributionDay !== null ? Number(body.autoContributionDay) : null }),
      ...("autoContributionFromWallet" in body && { autoContributionFromWallet: body.autoContributionFromWallet }),
