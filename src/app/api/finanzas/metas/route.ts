...
export async function POST(request: NextRequest) {
  ...
  const goal = await db.savingsGoal.create({
    data: {
      ...
      autoContributionAmount: body.autoContributionAmount ? Number(body.autoContributionAmount) : null,
      autoContributionDay: body.autoContributionDay ? Number(body.autoContributionDay) : null,
      autoContributionFromWallet: body.autoContributionFromWallet ?? null,
